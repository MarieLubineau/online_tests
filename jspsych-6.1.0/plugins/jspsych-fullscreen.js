  ...
  plugin.info = {
    ...
    parameters: {
      ...
      message: {
        ...
        pretty_name: 'Message',
        default: '<p class="pret">The experiment will switch to full screen mode when you press the button below</p>',
        array: false,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (keyboardNotAllowed) {
      ...
      if(trial.fullscreen_mode){
        display_element.innerHTML = '<div class="fullscreen">'+ trial.message + '<button id="jspsych-fullscreen-btn" class="jspsych-btn">'+trial.button_label+'</button>'+'</div>';
